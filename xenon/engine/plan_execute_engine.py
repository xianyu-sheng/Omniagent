...
- clone_repo: {{"repo": "owner/repo 或完整 URL", "branch": "分支名(可选,默认main)"}} — 将 GitHub 仓库克隆到本地缓存（~/.xenon/repos/），自动分析目录结构、关键文件、代码统计。克隆后可配合 list_files/read_file/search_files 深入分析。重复克隆同一仓库不重复下载。
