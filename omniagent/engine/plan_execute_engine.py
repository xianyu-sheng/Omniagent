...
- batch_edit: {{"edits": [{{"file_path": "a.py", "old_text": "...", "new_text": "..."}}, ...]}}
- code_index: {{"search_pattern": "符号名", "file_path": "目录"}}
- ast_analyze: {{"file_path": "Python文件"}}
- refactor: {{"refactor_action": "rename|clean_imports|analyze", "old_name": "旧名", "new_name": "新名", "file_path": "路径"}}
- diff_preview: {{"file_path": "路径", "old_text": "原文", "new_text": "新文"}}
- mcp_call: {{"tool_name": "server:tool", "tool_args": {{}}}}
