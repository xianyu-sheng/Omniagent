...
from omniagent.mcp.transport import MCPTransport, StdioTransport, SSETransport
...
class MCPClient:
    ...
    def __init__(self, transport: MCPTransport, name: str = "omniagent") -> None:
    ...
    def from_command(cls, command: str, args: list[str] | None = None,
                     env: dict[str, str] | None = None, name: str = "omniagent") -> MCPClient:
        """从命令行创建 stdio 客户端。"""
