...
[![release v0.7.0](https://img.shields.io/badge/release-v0.7.0-orange.svg)](https://github.com/xianyu-sheng/Xenon/releases/tag/v0.7.0)
...
v0.7.0 在新版 TUI、多模型、8 引擎和工具管线之上加入 User-Governed Memory
作为第四个产品支柱，并系统修复终端折叠、权限回执、上下文连续性与 DeepSeek
工具协议问题。
...
上述命令安装经过回归验证的 `v0.7.0` tag；参与开发时可去掉 `@v0.7.0` 跟随 `main`。
